...
public interface GlobalRefDatabase {
   ...
   *
   * <p>The concrete implementations of GlobalRefDatabase are supposed to provide a specific
   * implementation for this method that does not create any warnings in the logs.
   *
   * @param project project name of the ref
   * @param ref to be checked against global ref-db
   * @return true if it is; false otherwise
