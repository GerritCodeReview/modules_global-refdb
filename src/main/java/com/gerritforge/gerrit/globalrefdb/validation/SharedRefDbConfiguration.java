...
public class SharedRefDbConfiguration {
  ...
  public static class SharedRefDatabase {
     ...
     * SharedRefEnforcement.StorageRule#EXCLUDE}. Included refs will be stored in the global refdb
      ...
      for (String item : storageRulesList) {
        ...
        if (parts.size() == 2) {
          ...
          try {
            ...
            log.debug(String.format("%s %s is invalid regex.", SUBSECTION_STORAGE_RULES, value));
