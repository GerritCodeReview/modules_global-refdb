...
public class SharedRefDbConfiguration {
   ...
   * it is enabled, specific {@link LegacySharedRefEnforcement}s and to tune other parameters that define
  ...
  public static class SharedRefDatabase {
    ...
    /**
     * Getter for the map of {@link LegacySharedRefEnforcement.Policy} to a specific "project:refs". Each
     * entry can be either be {@link LegacySharedRefEnforcement.Policy#EXCLUDE} or {@link
     * LegacySharedRefEnforcement.Policy#INCLUDE} and it represents the level of consistency enforcements
     ...
     * default ({@link LegacySharedRefEnforcement#isRefToBeIgnoredBySharedRefDb(String)} or if it has been
