...
public class SharedRefDbConfiguration {
  ...
  public static class SharedRefDatabase {
    ...
    /**
     * Getter for the map of {@link Policy} to a specific "project:refs". Each entry can be either
     * be {@link Policy#EXCLUDE} or {@link Policy#INCLUDE} and it represents the level of
     * consistency enforcements for that specific "project:refs". If the project or ref is omitted,
     * apply the policy to all projects or all refs.
     *
