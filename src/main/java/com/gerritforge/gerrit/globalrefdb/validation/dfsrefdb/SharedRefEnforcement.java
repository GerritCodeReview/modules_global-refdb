...
public class SharedRefEnforcement {
  ...
  @Inject
  public SharedRefEnforcement(SharedRefDbConfiguration config, DraftCommentEventsEnabledProvider draftCommentEventsEnabledProvider) {
  ...
  @VisibleForTesting
  public SharedRefEnforcement(ImmutableList<String> storeAllRefs, ImmutableList<String> storeNoRefs, boolean enableDraftCommentEvents) {
  ...
  public SharedRefEnforcement() {
    this.storeAllRefs = ImmutableList.of();
    this.storeNoRefs = ImmutableList.of();
