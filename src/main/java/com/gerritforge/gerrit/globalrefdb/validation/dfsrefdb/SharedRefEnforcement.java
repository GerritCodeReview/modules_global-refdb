...
public interface SharedRefEnforcement {
  ...
  class Rule {
    String projectWildcard;
    String refWildcard;
    SharedRefEnforcement.Policy ruleType;

    public Rule(SharedRefEnforcement.Policy ruleType, String projectWildcard, String refWildcard) {
      this.ruleType = ruleType;
      this.projectWildcard = projectWildcard;
      this.refWildcard = refWildcard;
    }

    public boolean matches(String projectWildcard, String refWildcard) {
      return wildcardMatches(this.projectWildcard, projectWildcard)
          && wildcardMatches(this.refWildcard, refWildcard);
    }
